...
def render_report(
    ...
    provider_label = {
        ...
        "census": "Census", "ecb": "ECB", "fed": "Fed", "nbs": "NBS",
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    ap.add_argument(
        "--provider",
        choices=["te", "eodhd", "bls", "bea", "census", "fed", "ecb", "nbs"],
        default="te",
        help=(
            "which acquisition lane to validate. "
            "bls / bea / census / ecb / fed / nbs all have live probes."
        ),
    )
    ap.add_argument(
