...
_OFFICIAL_PROVIDERS_WITH_PROBES: frozenset[str] = frozenset({"bls", "bea"})
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    ap.add_argument(
        ...
        help=(
            ...
            "bls (P1b) + bea (P2b) have live probes; fed/ecb/nbs are "
            "scaffold-only — probe bodies land in P3b/P4b/P5c."
        ),
    )
    ap.add_argument(
...
def main(argv: list[str] | None = None) -> int:
    ...
    # scaffold-only stub. BLS + BEA now have live probes; Fed / ECB /
