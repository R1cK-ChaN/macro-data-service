...
class LocalMacroDataService:
    ...
    def _op_calendar_econ_sweep_values(
        ...
        Arguments:
          ...
          connectors   — optional list subset of
                         ...
                         "zew", "ifo", "insee", "ine", "istat", "fed-values",
    ...
    def _op_calendar_econ_refresh_schedules(
        ...
        Census + ISM + U Michigan + Conference Board + NAR + ECB + Eurostat + Destatis + ZEW + Ifo +
        INSEE + INE + ISTAT +
        ...
        Arguments:
          ...
          connectors — optional list subset of
                       ``["bls","bea","census","ism","umich",
                       "conference-board","nar","ecb","eurostat","destatis","zew","ifo","insee","ine","istat","fed-fomc",
