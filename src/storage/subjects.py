...
class SubjectTagger:
    ...
    def tag_structured(
        ...
        *,
        ...
        bundesbank_series: str | Iterable[str] | None = None,
        mof_jp_series: str | Iterable[str] | None = None,
        aisi_series: str | Iterable[str] | None = None,
        ism_series: str | Iterable[str] | None = None,
        redbook_series: str | Iterable[str] | None = None,
        sentix_series: str | Iterable[str] | None = None,
        ...
        pairs = (
            ...
            ("bundesbank_series", bundesbank_series),
            ("mof_jp_series", mof_jp_series),
            ("aisi_series", aisi_series),
            ("ism_series", ism_series),
            ("redbook_series", redbook_series),
            ("sentix_series", sentix_series),
