...
_ALIASES: dict[str, str] = {
    ...
    # ── South Africa (Stats SA / SARB, issue #90 P1) ───────────
    "south africa consumer price index": "CPI",
    "south africa cpi": "CPI",
    "south africa inflation rate": "CPI",
    "south african cpi": "CPI",
    "south africa producer price index": "PPI",
    "south africa ppi": "PPI",
    "south africa producer prices": "PPI",
    "south african ppi": "PPI",
    "south africa gdp": "GDP",
    "south africa gdp growth rate": "GDP",
    "south african gdp": "GDP",
    "south africa unemployment rate": "UNEMPLOYMENT_RATE",
    "south african unemployment rate": "UNEMPLOYMENT_RATE",
    "quarterly labour force survey": "UNEMPLOYMENT_RATE",
    "qlfs": "UNEMPLOYMENT_RATE",
    "south africa mining production": "MINING_PRODUCTION",
    "south african mining production": "MINING_PRODUCTION",
    "mining production": "MINING_PRODUCTION",
    "mining production and sales": "MINING_PRODUCTION",
    "south africa manufacturing production": "MANUFACTURING_PRODUCTION",
    "south african manufacturing production": "MANUFACTURING_PRODUCTION",
    "manufacturing production": "MANUFACTURING_PRODUCTION",
    "manufacturing production and sales": "MANUFACTURING_PRODUCTION",
    "south africa retail sales": "RETAIL_SALES",
    "south african retail sales": "RETAIL_SALES",
    "retail trade sales": "RETAIL_SALES",
    "retail sales": "RETAIL_SALES",
    # SARB repo (repurchase) rate — operational policy rate set by
    # the Monetary Policy Committee.
    "sarb interest rate decision": "SARB_RATE",
    "south african reserve bank interest rate decision": "SARB_RATE",
    "south africa interest rate decision": "SARB_RATE",
    "sarb rate decision": "SARB_RATE",
    "sarb policy rate": "SARB_RATE",
    "south africa repo rate": "SARB_RATE",
