...
when the incoming precision is less granular). A future BEA P2a
schedule scraper will call :func:`project_schedule_events` for
its pre-release writes so BEA value-side upserts do not clobber
