...
## Retired HTML Scraper Subtree

Issue #123 retired the Investing.com, ForexFactory, and TradingEconomics HTML
scraper clients. Calendar ingestion now runs through source-owned official API
packages, `calendar/te_api`, and `calendar/eodhd_api`.
