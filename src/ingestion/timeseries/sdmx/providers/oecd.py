...
Full implementation moved from scrapers/oecd.py into the unified SDMX layer.
Uses XML for structure endpoints and JSON for data, with v2 URL fallback.
"""
...
from .._errors import OECDAPIError, OECDRateLimitError, OECDResponseFormatError
