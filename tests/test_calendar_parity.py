...
def test_provider_constants_align_with_parser_ids() -> None:
    ...
    from ingestion.calendar.mospi_api.parser import PROVIDER as MOSPI
    from ingestion.calendar.rbi_api.parser import PROVIDER as RBI
    from ingestion.calendar.kostat_api.parser import PROVIDER as KOSTAT
    ...
    from ingestion.calendar.inegi_api.parser import PROVIDER as INEGI
    from ingestion.calendar.banxico_api.parser import PROVIDER as BANXICO
    from ingestion.calendar.statssa_api.parser import PROVIDER as STATSSA
    from ingestion.calendar.sarb_api.parser import PROVIDER as SARB
    from ingestion.calendar.bi_api.parser import PROVIDER as BI
    ...
    assert set(OFFICIAL_PROVIDERS) == {
        ...
        TUIK, TCMB, INEGI, BANXICO, STATSSA, SARB, BI,
    }
