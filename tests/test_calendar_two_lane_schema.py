...
def test_cal_provider_seeded(store: SQLiteEngineStore) -> None:
    ...
    assert rows == [
        ...
        ("boe-speeches",     "central_bank",      "economic",  100),
        ("boj",              "central_bank",      "economic",  100),
        ("boj-speeches",     "central_bank",      "economic",  100),
        ("bok",              "central_bank",      "economic",  100),
