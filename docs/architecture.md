...
- **Remaining:** official-source economic connectors (BLS/ECB/Fed/NBS); legacy HTML-scraped `calendar_events` parity + retirement; downstream `GET /calendar` HTTP surface over `v_calendar_item`.
