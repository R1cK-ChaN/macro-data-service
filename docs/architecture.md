...
- **Remaining:** indicator-whitelist expansion; P2 BEA / P3 ECB / P4 Fed / P5 NBS connectors; P6 cross-provider parity harness; P7 downstream `GET /calendar` HTTP surface over `v_calendar_item`; P8 TE subscription retirement once P6 passes.
