...
- Status: **ok**
- HTTP elapsed: 9260 ms
- Row count: 81
- Note: entries by indicator: MANUFACTURING_PMI=12, NON_MANUFACTURING_PMI=12, CPI=12, PPI=12, INDUSTRIAL_PRODUCTION=11, FIXED_ASSET_INVESTMENT=11, RETAIL_SALES=11

#### Enum observations (all rows)

- `indicator`: MANUFACTURING_PMI=12, NON_MANUFACTURING_PMI=12, CPI=12, PPI=12, INDUSTRIAL_PRODUCTION=11, FIXED_ASSET_INVESTMENT=11, RETAIL_SALES=11
